                            ...
                            <form action="{{route('certificate.update',$certificate->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control" name="start_date" id="start" value="{{ $certificate->start_date }}" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="end_date">End Date</label>
                                        <input type="date" class="form-control" name="end_date" id="end" value="{{ $certificate->end_date }}" required>
                                    </div>
                                </div>

                                <div class="from-group">
                                    <label for="location">Enter Your Graduate or Certified Location</label>
                                    <input type="text" name="location" class="form-control" value="{{$certificate->location}}">
                                    @error("location")
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-inline d-flex justify-content-start align-items-center">
                                        <div class="position-relative">
                                            ...
                                            <img src="{{asset($certificate->photo)}}" style="height: 200px;width: 200px" class="mr-2 rounded current-img" alt="">
                                        </div>
